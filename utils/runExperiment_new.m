...
isBlankTest = input('Is this a blank test? (1 for Yes, 0 for No): ');
...
% Ask for user-defined filename
userFilename = input('Enter filename to save the data: ', 's'); 
...
filePath = fullfile(datasetFolder, [userFilename, '.mat']);

% Save data to the specified folder
save(filePath, 'time_stamps', 'sensor_data', 'MQnames', 'userFilename');

disp(['✅ Data saved as ', filePath]);
